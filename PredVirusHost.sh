...
mv output.txt output_tmp.txt scores.txt output_sig_hits_only.txt temp_file.txt scores_calc.txt output_scores.txt proteins_and_contigs_names.txt fastafile.txt output_with_species.txt $file1.temp.folder
...
command cat $file1.temp.folder/scores.txt > $file1.scores.txt
